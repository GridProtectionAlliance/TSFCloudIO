--  ----------------------------------------------------------------------------------------------------
--  TSFCloudIO Data Structures for SQL Server - Gbtc
--
...
--       Script is based on TSFCloudIO.sql script created by James Ritchie Carroll.
...
USE [master]
GO
CREATE DATABASE [TSFCloudIO];
GO
ALTER DATABASE [TSFCloudIO] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [TSFCloudIO] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [TSFCloudIO] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [TSFCloudIO] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [TSFCloudIO] SET ARITHABORT OFF 
GO
ALTER DATABASE [TSFCloudIO] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [TSFCloudIO] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [TSFCloudIO] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [TSFCloudIO] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [TSFCloudIO] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [TSFCloudIO] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [TSFCloudIO] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [TSFCloudIO] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [TSFCloudIO] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [TSFCloudIO] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [TSFCloudIO] SET  ENABLE_BROKER 
GO
ALTER DATABASE [TSFCloudIO] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [TSFCloudIO] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [TSFCloudIO] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [TSFCloudIO] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [TSFCloudIO] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [TSFCloudIO] SET  READ_WRITE 
GO
ALTER DATABASE [TSFCloudIO] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [TSFCloudIO] SET  MULTI_USER 
GO
ALTER DATABASE [TSFCloudIO] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [TSFCloudIO] SET DB_CHAINING OFF 
GO
-- The next three commented statements are used to create a user with access to the TSFCloudIO database.
...
--GO
--CREATE ROLE [TSFCloudIOManagerRole] AUTHORIZATION [dbo]
--GO
--EXEC sp_addrolemember N'TSFCloudIOManagerRole', N'NewUser'
--GO
--EXEC sp_addrolemember N'db_datareader', N'TSFCloudIOManagerRole'
--GO
--EXEC sp_addrolemember N'db_datawriter', N'TSFCloudIOManagerRole'
--GO

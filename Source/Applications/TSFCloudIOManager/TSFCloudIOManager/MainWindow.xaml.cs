    ...
    public partial class MainWindow : ResizableWindow
    {
        ...
        private void ButtonHelp_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                Process.Start("https://github.com/GridProtectionAlliance/tsfcloudio");
            }
            catch
            {
                useLocalHelp = true;
            ...
            if (useLocalHelp)
            {
                try
                {
                    ...
                    string helpfile = FilePath.GetAbsolutePath("TSFCloudIOManagerHelp.mht");

                    if (File.Exists(helpfile))
                        Process.Start(helpfile);
                    else
                        MessageBox.Show("Local help file \"" + helpfile + "\" was not found", "TSFCloudIO Manager Help", MessageBoxButton.OK, MessageBoxImage.Warning);
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Failed to launch local help file." + Environment.NewLine + ex.Message, "TSFCloudIO Manager Help", MessageBoxButton.OK, MessageBoxImage.Error);
                }
            }
